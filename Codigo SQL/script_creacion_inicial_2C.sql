...
NO ESTA TERMINADA PUNTO 5.

SELECT CLIENTE.CLI_COD_USUARIO, SUM(FACTURA.FAC_TOTAL)/10 AS PUNTOS_POR_ESTADIAS, SUM(FACTURA_ITEM.FACITEM_MONTO)/5 AS PUNTOS_POR_CONSUMIBLES
...
GROUP BY CLIENTE.CLI_COD_USUARIO
