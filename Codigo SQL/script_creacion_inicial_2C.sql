...
CREATE TABLE [LA_REVANCHA].[USUARIO](
			 ...
			 [USU_LOGIN_PERMITIDO] [BIT] DEFAULT 0,
...
INSERT INTO LA_REVANCHA.FACTURA_ITEM(FACITEM_COD_FACTURA,FACITEM_COD_CONSUMIBLE,FACITEM_CANTIDAD,FACITEM_MONTO, FACITEM_HABITACION)
SELECT DISTINCT M.Factura_Nro, M.Consumible_Codigo, M.Item_Factura_Cantidad, M.Item_Factura_Monto, HA.HAB_CODIGO
