...
WHERE FUN_CODIGO <> 103 AND FUN_CODIGO <> 106 AND FUN_CODIGO <> 107 AND FUN_CODIGO <> 108 AND FUN_CODIGO <> 109
	   
--TABLA FUNCION_ROL RECEP	   
INSERT INTO LA_REVANCHA.FUNCION_ROL(FUNROL_ROL,FUNROL_FUNCION)
SELECT 20,FUN_CODIGO 
FROM LA_REVANCHA.FUNCION 
WHERE FUN_CODIGO <> 101 AND FUN_CODIGO <> 102 AND FUN_CODIGO <> 104 AND FUN_CODIGO <> 105 AND FUN_CODIGO <> 110

--TABLA FUNCION_ROL CLIENTE
INSERT INTO LA_REVANCHA.FUNCION_ROL(FUNROL_ROL,FUNROL_FUNCION)
SELECT 30,FUN_CODIGO 
FROM LA_REVANCHA.FUNCION 
WHERE FUN_CODIGO <> 101 AND FUN_CODIGO <> 102 AND FUN_CODIGO <> 103 AND FUN_CODIGO <> 104 AND FUN_CODIGO <> 105 
	  AND FUN_CODIGO <> 107 AND FUN_CODIGO <> 108 AND FUN_CODIGO <> 109 AND FUN_CODIGO <> 110
